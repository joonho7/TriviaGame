...
var game = {
    ...
    start: function() {
        ...
        $("#game-area").prepend("<h2>Time Remaining: <span id='time-count'>120</span> Seconds</h2>");
        $("#start").remove();
        $('#click-start').remove();
    ...
    result: function() {
        ...
        $('#game-area').html("<h2>All Done!</h2>");
        $('#game-area').append("<h3>Correct Answers: " + this.correct + "</h3>");
        $('#game-area').append("<h3>Incorrect Answers: " + this.incorrect + "</h3>");
        $('#game-area').append("<h3>Unanswered: " + (questions.length - (this.incorrect + this.correct)) + "</h3>");
    }
};
