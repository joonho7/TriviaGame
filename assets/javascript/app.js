...
// ------------------------------------------------------------------------
var Q1 = [{question:"Which two actors directed themselves in movie and won Oscars for Best Actor?",
...
var Q2 = [{question:"“After all, tomorrow is another day!” Was the last line in which Oscar-winning Best Picture?",
answers:["Gone With the Wind", "Great Expectations", "Harold and Maude", "The Matrix "],
rightAnswer:"Gone With the Wind" 
}]

var Q3 = [{question: "Who is the only person to win an Oscar for Best Director for the only movie he ever directed?", 
answers:["Bob Fosse", "Frank Borzage", "Leo McCarey", "Jerome Robbins"],
rightAnswer: "Jerome Robbins" 
}]

var Q4 = [{question:"Who is the most nominated actor in Academy history?",
answers:["Jack Nicholson", "Laurence Olivier", "Spencer Tracy", "Paul Newman"],
rightAnswer: "Jack Nicholson"
}]

var Q5 = [{question:"In which movie was the Oscar-winning song 'Do Not Forsake Me, Oh My Darlin' prominently featured?",
answers:["Butch Cassidy and the Sundance Kid", "Calamity Jane", "High Noon", "Song of the South"],
rightAnswer:"High Noon"
}]

var Q6 = [{question:"Which classic Billy Wilder film noir was the basis for the plot in director Lawrence Kasdan’s neo-noir Body Heat, starring Kathleen Turner and William Hurt?",
answers:["Ace in the Hole", "Double Indemnity", "The Maltese Falcon", "Sunset Boulevard"],
rightAnswer:"Double Idemnity"
}]

var Q7 = [{question:"What was the first Western to win the Academy Award for Best Picture?",
answers:["Brokeback Mountain", "Cimarron", "The Last Wagon", "Stagecoach"],
rightAnswer:"Cimarron"
}]

var Q8= [{question:"What was the first film to receive an Academy Award nomination in each of the performance categories?",
answers:["A Streetcar Named Desire", "The Color Purple", "My Man Godfrey", "The Turning Point"],
rightAnswer:"My Man Godfrey"
}]

var Q9 = [{question:"What Cameron Crowe-directed Hollywood remake was the setting for the on-screen and real-life romance of married actor Tom Cruise and Spanish star Penelope Cruz?",
answers:["Magnolia", "Masked and Anonymous", "Vanila Sky", "Waking up in Reno"],
rightAnswer:"Vanila Sky"
}]

var Q10= [{quetion:"Which movie ends with this final line of dialogue: “Why, she wouldn’t even harm a fly?",
